...
/*
 * Parameters: handles the interaction with the outside world and memory handling
 * its data member is a pointer to an abstract class
 * ParametersInner: define the interface that the concrete classes eventually implement must fulfill
 */
